...
function caso_especial_mil() {
    $texto = ["decenas_mil" => "", "unidades_mil" => "", "mil" => "mil",
...
function rango_30($saldo) {
    if ($saldo == 30) {
        return $salida = ["texto" => "treinta ", "numero" => 0];
    } elseif ($saldo > 30) {
        return $salida = ["texto" => "treinta y ", "numero" => $saldo - 30];
    }
}

function rango_40($saldo) {
    if ($saldo == 40) {
        return $salida = ["texto" => "cuarenta ", "numero" => 0];
    } elseif ($saldo > 40) {
        return $salida = ["texto" => "cuarenta y ", "numero" => $saldo - 40];
    }
}

function rango_50($saldo) {
    if ($saldo == 50) {
        return $salida = ["texto" => "cincuenta ", "numero" => 0];
    } elseif ($saldo > 50) {
        return $salida = ["texto" => "cincuenta y ", "numero" => $saldo - 50];
    }
}

function rango_60($saldo) {
    if ($saldo == 60) {
        return $salida = ["texto" => "sesenta ", "numero" => 0];
    } elseif ($saldo > 60) {
        return $salida = ["texto" => "sesenta y ", "numero" => $saldo - 60];
    }
}

function rango_70($saldo) {
    if ($saldo == 70) {
        return $salida = ["texto" => "setenta ", "numero" => 0];
    } elseif ($saldo > 70) {
        return $salida = ["texto" => "setenta y ", "numero" => $saldo - 70];
    }
}

function rango_80($saldo) {
    if ($saldo == 80) {
        return $salida = ["texto" => "ochenta ", "numero" => 0];
    } elseif ($saldo > 80) {
        return $salida = ["texto" => "ochenta y ", "numero" => $saldo - 80];
    }
}

function rango_90($saldo) {
    if ($saldo == 90) {
        return $salida = ["texto" => "noventa ", "numero" => 0];
    } elseif ($saldo > 90) {
        return $salida = ["texto" => "noventa y ", "numero" => $saldo - 90];
    }
}
